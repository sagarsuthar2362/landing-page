...
const Home = () => {
  return (
    <div>
      ...
      <div className="home2 h-[120vh] bg-gray-800 -mt-[200px] z-1 flex items-center justify-between ">
        <img src={vg} />
      ...
      <div className="home3 h-screen bg-gray-800">
        <div className="bg-white h-8/12 w-9/12 flex flex-col items-center justify-center p-20 rounded-r-[200px] space-y-5">
          <h1 className="text-4xl font-semibold border-b-3 ">Who we are?</h1>
          <p>
      ...
      <div className="home4 h-screen bg-gray-800 flex justify-end">
        <div className="bg-blue-400 h-8/12 w-9/12 flex flex-col items-center justify-center p-20 rounded-l-[200px] space-y-10">
          <h1 className="text-4xl font-semibold border-b-3 ">Brands</h1>
          <div className="brand-icons flex gap-18">
            <div
